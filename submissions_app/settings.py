"""
Django settings for submissions_app project.
...
config.read('%s/config.txt' % (BASE_DIR))
...
ALLOWED_HOSTS = ['https://app-submissions.herokuapp.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #'apps.context_processors.md5hash'
...
WSGI_APPLICATION = 'submissions_app.wsgi.application'
